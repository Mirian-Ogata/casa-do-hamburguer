...
const Button = ({
  ...
  const buttonVariant = () => {
    if (variant === "default-orange") {
      return "p-2 flex items-center justify-center w-full cursor-pointer rounded-md border border-[#C92A0E] bg-[#C92A0E] text-xs font-bold text-white";
    } else if (variant === "outline-orange") {
      return "p-2 flex items-center justify-center w-full cursor-pointer rounded-md border border-[#c92a0e] bg-white  text-xs font-bold text-[#c92a0e]";
